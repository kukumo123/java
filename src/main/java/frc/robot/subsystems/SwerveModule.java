...
public class SwerveModule {
    ...
    public double getDrivePosition() {
        return driveMotor.getPosition().getValue() * Constants.Swerve.ModuleConstants.kDriveMotorGearRatio;
    }
    ...
    public double getDriveVelocity() {
        return driveMotor.getVelocity().getValue() * Constants.Swerve.ModuleConstants.kDriveEncoderRPM2MeterPerSec;
    }
    ...
    public SwerveModuleState setDesiredState(SwerveModuleState state) {
        ...
        driveMotor.set(state.speedMetersPerSecond / Constants.Swerve.DriveConstants.kPhysicalMaxSpeedMetersPerSecond);
