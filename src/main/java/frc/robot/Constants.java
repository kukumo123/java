...
public final class Constants {
  public static final class Swerve {
    ...
    public static final class ModuleConstants {
        ...
        public static final double kAngleMotorGearRatio = 1 / 100.0;
        public static final double kDriveEncoderRot2Meter = kDriveMotorGearRatio * Math.PI * kWheelDiameterMeters;
        public static final double kTurningEncoderRot2Rad = kTurningMotorGearRatio * 2 * Math.PI;
        public static final double kAngleEncoderRot2Rad = kAngleMotorGearRatio * 360;
    ...
    public static final class DriveConstants {
        ...
        public static final double kPAlign = 1;
        public static final double kIAlign = 0;
        public static final double kDAlign = 0;  
      }
